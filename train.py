...
def train(args, data, show_loss, show_topk):
    ...
    model = DAN(args, n_user, n_entity, n_relation, adj_entity, adj_relation)
    ...
    with tf.Session() as sess:
        ...
        for step in range(args.n_epochs):
            ...
            if test_auc > max_auc[0]:
                max_auc = (test_auc, test_f1)
            ...
            if show_loss:
                print(total_loss * args.batch_size / start)
            ...
            if show_topk:
                ...
                for i in recall:
                    print('%.4f\t' % i, end='')
                print('\n')
    print('max: auc:%.4f\tf1:%.4f' % max_auc)
